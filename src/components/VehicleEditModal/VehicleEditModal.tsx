  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-600 bg-opacity-75 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[95vh] overflow-y-auto p-6">
        ...
        {/* Fuel & Battery */}
        <h3 className="text-lg font-semibold mt-6 mb-2 border-b pb-1">
          Fuel & Battery
        </h3>
        ...
        <div className="mb-6">
          ...
          {/* Drag & Drop area */}
          <div
            className="border-2 border-dashed border-gray-400 rounded p-4 text-center cursor-pointer hover:border-blue-500 transition"
            onDrop={(e) => {
              e.preventDefault();
